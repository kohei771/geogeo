...
_C.exp_name = 'newmethod_intensity_dim1_log1p_intensitygrad'
...
_C.train.use_intensity = True  # Use intensity as features
...
_C.test.use_intensity = True  # Use intensity as features
