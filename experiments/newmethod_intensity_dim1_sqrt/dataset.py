...
from geotransformer.datasets.registration.newmethod_intensity_dim1_sqrt.dataset import NewMethodIntensityPairDataset
...
class IntensityOnlyDataset(NewMethodIntensityPairDataset):
    ...
    def __init__(self, *args, use_near=False, **kwargs):
        super().__init__(*args, use_near=use_near, **kwargs)
